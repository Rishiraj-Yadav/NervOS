...
NervOS is a self-hosted AI-agent runtime and management platform. The repository has completed **Stage C — Persistent execution engine**, and the next milestone is **Stage D — tool and MCP layer**.
