...
**D3 — tool registry, canonical schema, and the first built-in tools is complete and accepted**. The
next milestone is **D4 — provider-neutral tool calling and the Think → Act → Observe loop**.
...
The next engineering milestone is **D4 — provider-neutral tool calling and the Think → Act → Observe loop**.
