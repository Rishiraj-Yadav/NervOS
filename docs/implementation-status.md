...
The next milestone is **D6 — Tool audit, failure semantics, and C3–C6 integration**.
...
The next engineering milestone is **D6 — Tool audit, failure semantics, and C3–C6 integration**.
